...
(function($){
	...
	view = {
		...
		asyncNode: function(setting, node, isSilent, callback) {
			...
			otherParam = $.extend(true, otherParam, setting.async.data || {});
			...
			$.ajax({
				...
				data: JSON.stringify(otherParam) != "{}" ? JSON.stringify(otherParam) : null,
