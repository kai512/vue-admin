...
_e(function (E, $) {
    ...
    E.plugin(function () {
        ...
        fns.onload || (fns.onload = function (resultText, xhr) {
        	resultText = JSON.parse(resultText).content[0].filePath;
...
_e(function (E, $) {
    ...
    E.plugin(function () {
        ...
        editor.xhrUploadImg = function (opt) {
            ...
            // 填充数据
            params.filename = E.random() + '.' + fileExt;
            formData.append(name, convertBase64UrlToBlob(base64, fileType), params.filename);
...
_e(function (E, $) {
    ...
    UploadFile.fn.bindLoadEvent = function () {
        ...
        // 定义load事件
        function onloadFn() {
            var resultText = $.trim(iframeWindow.document.body.innerText);
            if (!resultText) {
                return;
            }
            // 获取文件名
...
_e(function (E, $) {
    ...
    E.plugin(function () {
        ...
        var config = editor.config;
        var uploadImgUrl = config.uploadImgUrl;
        var uploadFileName = config.uploadImgFileName || 'wangEditorH5File';
